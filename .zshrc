...
#plugins=( git zsh-autosuggestions zsh-syntax-highlighting zsh-completions kubectl bindkey)
plugins=( git zsh-autosuggestions zsh-syntax-highlighting zsh-completions kubectl globalias )
